...
# Definirea directoarelor seturilor de date și clasele de categorii 
...
# Funcție de încărcare și preprocesare a imaginii
...
# Funcție de încărcare și preprocesare a setului de date cu etichete one-hot 
...
# Încărcarea seturilor de date cu etichetele one-hot
...
# Evitarea duplicării greutăților
...
plot_training_history(history, save_path='mobileNetV2_training_history.png')